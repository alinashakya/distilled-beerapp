...
class Brewerydb
{
    ...
    /**
     * Sets the response format in 'php' or 'json' format
     *
     * @return string
     */
    ...
    public function request($endpoint, $args = array(), $transferType = self::GET)
    {
        ...
        if (isset($this->_lastParsedResponse['error'])) {
            require_once 'Pintlabs/Service/Brewerydb/Exception.php';
            throw new Pintlabs_Service_Brewerydb_Exception('Brewerydb Service Error: ' . $this->_lastParsedResponse['error']['message']);
        }
